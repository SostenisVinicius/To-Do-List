  ...
  return (
    <div className="mx-auto max-w-sm px-4 sm:px-6 lg:max-w-7xl lg:px-6 flex-col flex items-center justify-center">
      ...
      <div className="w-full h-11 mt-8 flex items-center justify-center">
        ...
        <button
          type="button"
          className="inline-flex ml-4 w-full h-11 justify-center items-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 sm:mt-0 sm:w-auto"
          onClick={() => setOpen(true)}
        >
